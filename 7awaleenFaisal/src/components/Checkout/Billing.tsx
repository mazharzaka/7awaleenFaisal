...
const Billing = () => {
  return (
    <div className="mt-9">
      <h2 className="font-medium  text-dark dark:text-[#8b8b8b] dark:text-[#E0E0E0]  text-xl sm:text-2xl mb-5.5">
        Billing details
      </h2>

      <div className="bg-white  dark:bg-[#121212]   shadow-1 rounded-[10px] p-4 sm:p-8.5">
        ...
        <div>
          <label
            ...
            className=" text-dark dark:text-[#8b8b8b] dark:text-[#E0E0E0]  flex cursor-pointer select-none items-center"
          >
            <div className="relative">
              <input
                type="checkbox"
