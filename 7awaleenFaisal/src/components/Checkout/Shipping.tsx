...
const Shipping = () => {
  ...
  return (
    <div className="bg-white  dark:bg-[#121212]   shadow-1 rounded-[10px] mt-7.5">
      <div
        onClick={() => setDropdown(!dropdown)}
        className="cursor-pointer flex items-center gap-2.5 font-medium text-lg  text-dark dark:text-[#8b8b8b] dark:text-[#E0E0E0]  py-5 px-5.5"
      >
